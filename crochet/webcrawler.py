...
'''
def webcrawler():
    starter_url = 'https://en.wikipedia.org/wiki/Crochet'
...
def webscraper():
    ...
    ignore = ['jstor', 'TheLadysAssistant', 'britannica', 'lacismuseum', 'crochet.org/?page=CrochetHistory',
              'crochetliberationfront', 'crochetforcancer', 'soldiersangels', 'theiff', 'lafayette',
              'antiquepatternlibrary.org', 'mediawiki.org', 'craftyarncouncil.com']
    # is_ignored = False
...
def cleanup(fileamnt):
    ...
    substantial_urls.remove(8)
    substantial_urls.remove(10)
    substantial_urls.remove(48)
    substantial_urls.remove(61)
...
def main():
    ...
    most_important = ['crochet', 'yarn', 'stitch', 'hook', 'lace', 'single', 'double',
                      'slip', 'chain', 'art', 'century', 'silk', 'textile', 'needle', 
                      'gauge', 'pattern', 'loop', 'row']
